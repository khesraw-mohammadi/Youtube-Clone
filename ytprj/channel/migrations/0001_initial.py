# Generated by Django 5.0.2 on 2024-02-14 07:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('active', 'Active'), ('Disable', 'disabke')], default='active', max_length=100)),
                ...
                ('subscribers', models.ManyToManyField(related_name='user_sub', to=settings.AUTH_USER_MODEL)),
